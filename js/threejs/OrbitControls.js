/*
Need to create a copy of three/examples/jsm/controls/OrbitControls
Because OrbitControls swallows eventListeners, but I need to listen
to mousedown/mouseup to differentiate dragging from clicking 

See more: https://github.com/mrdoob/three.js/issues/8084
*/
...
var OrbitControls = function (object, domElement) {
	...
	function handleMouseMoveRotate(event, friction = 1) {
		...
		rotateLeft((2 * Math.PI * rotateDelta.x) / element.clientHeight / friction); // yes, height

		rotateUp((2 * Math.PI * rotateDelta.y) / element.clientHeight / friction);
